...
fun SplashScreen(navController: NavController) {
    ...
    LaunchedEffect(key1 = true){
        ...
        navController.navigate(AppScreens.MasterScreen.route)
    }
...
fun Splash() {
    Column(
        ...
        Image(
            ...
            painter = painterResource(id = R.drawable.developers_splash_screen),
            // Descripción de la imagen para accesibilidad
            contentDescription = "logo de la app: developers",
